...
export const history = [
  ...
  },
  {
    ...
    company: 'Roche',
    jobTitle: 'Front-end Developer',
    description: `Development of variety of projects using JavaScript, jQuery, Backbone.js, AngularJS, PHP, Symfony 2.x,
      MySQL and elements of Java.`
  },
  {
  ...
  {
    timespan: '10.2011 - 07.2012',
    company: 'Status-C',
    jobTitle: 'PHP Programmer',
    description: `Development of web-based applications. Technologies used: PHP, Zend Framework, JavaScript, jQuery,
      MySQL, small bit of C# (Unity3D). Main operating system used at work: Linux.`
  },
  {
    timespan: '07.2011 - 10.2012',
    company: 'Forum Media',
    jobTitle: 'E-mail Development Specialist',
